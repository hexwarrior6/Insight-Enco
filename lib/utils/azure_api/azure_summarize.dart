...
Future<String> azure_summarize(String text) async {
        ...
        "content": [
          {
            "type": "text",
            "text":
                "I am a ICT staff, to have a summarize of this problem(about 6 words would be enough)."
          }
        ]
      },
      {
...
Future<void> main() async {
  print(await azure_summarize('The login system was too slow'));
}