...
Future<String> azure_chat(String text) async {
    ...
    "messages": [
      {
        ...
        "content": [
          {
            "type": "text",
            "text": "You are need to help a ICT staff to get some information about the feedback for customers and may need you to solve these problems.",
          }
        ]
      },
      {
...
Future<void> main() async {
  print(await azure_chat('How can to dell with the login system was too slow'));
}