...
Future<String> azure_classify(String text) async {
        ...
        "content": [
          {
            "type": "text",
            "text":
                "Classify the following feedback into 1 of the following categories: Technical support, system stability, user experience, feature requests and enhancement, security, training and documentation, cost-effectiveness, overall satisfaction, return me just one word."
          }
        ]
      },
      {
...
Future<void> main() async {
  print(await azure_classify('The login system was too slow'));
}